...
const apiData = async() => {
const news= await axios.get('https://newsapi.org/v2/everything?q=apple&from=2023-08-14&to=2023-08-14&sortBy=popularity&apiKey=09b7072f97714d4a9ca8773d8634817f')
